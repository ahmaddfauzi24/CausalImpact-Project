...
In the business process, the marketing team plays a crucial role in raising awareness of a product in the market. The success of marketing efforts is often measured by the number of leads generated. In a digital context, "leads" refer to individuals who show interest in a product or service through various online actions such as visiting a website, interacting with an ad, or sharing marketing content.

This process begins when the marketing team successfully captures the attention of potential customers and sparks their interest. The next step is to capture their contact information and direct them to the sales team for further follow-up. There are various strategies that can be used to generate "leads", from creating engaging content, doing various forms of advertising, to providing incentives such as promo codes or e-books.

Thus, marketing efforts not only aim to increase brand awareness, but also to gather leads that can be converted into potential customers through the right marketing measures.
